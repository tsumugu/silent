...
export const MusicDetailView: React.FC<MusicDetailViewProps> = ({ id, type, onBack, onPlaySong }) => {
    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center h-full text-white/50 gap-4">
                ...
                <span className="text-sm font-medium tracking-wide">Loading {type.toLowerCase()}...</span>
            </div>
        );
    }
    ...
    const artistName = data.artist?.name || data.author?.name || 'Unknown Artist';
                ...
                <div className="flex flex-col md:flex-row gap-10 mb-12">
                    ...
                    <div className="flex flex-col justify-end">
                        <div className="flex items-center gap-2 mb-3">
                            <span className="text-white/30 text-[10px] uppercase tracking-[0.2em] font-bold ring-1 ring-white/10 px-2 py-0.5 rounded-sm">
                                {type}
                            </span>
                        </div>
